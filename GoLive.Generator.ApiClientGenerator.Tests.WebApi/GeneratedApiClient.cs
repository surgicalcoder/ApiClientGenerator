...
namespace GoLive.Generator.ApiClientGenerator.Tests.WebApi.Generated
{
    ...
    public class InheritingTwoClient
    {
        ...
        public async Task<Response<global::System.Collections.Generic.IEnumerable<string>>> Get(Dictionary<string, string?> queryString = default, CancellationToken _token = default , JsonTypeInfo<global::System.Collections.Generic.IEnumerable<string>> _typeInfo = default)
        {
            ...
            if (_typeInfo != default) 
                return new Response<global::System.Collections.Generic.IEnumerable<string>>(result.StatusCode,await (result.Content?.ReadFromJsonAsync<global::System.Collections.Generic.IEnumerable<string>>(cancellationToken: _token , jsonTypeInfo: _typeInfo) ?? Task.FromResult<global::System.Collections.Generic.IEnumerable<string>?>(default)));
            else
                return new Response<global::System.Collections.Generic.IEnumerable<string>>(result.StatusCode,await (result.Content?.ReadFromJsonAsync<global::System.Collections.Generic.IEnumerable<string>>(cancellationToken: _token) ?? Task.FromResult<global::System.Collections.Generic.IEnumerable<string>?>(default)));
        }
        ...
        public async Task<Response<string>> GetUser(int Id , Dictionary<string, string?> queryString = default, CancellationToken _token = default , JsonTypeInfo<string> _typeInfo = default)
        {
            ...
            using var result = await _client.GetAsync(Microsoft.AspNetCore.WebUtilities.QueryHelpers.AddQueryString($"/InheritingTwo/", queryString), cancellationToken: _token);
            if (_typeInfo != default) 
                return new Response<string>(result.StatusCode,await (result.Content?.ReadFromJsonAsync<string>(cancellationToken: _token , jsonTypeInfo: _typeInfo) ?? Task.FromResult<string?>(default)));
            else
                return new Response<string>(result.StatusCode,await (result.Content?.ReadFromJsonAsync<string>(cancellationToken: _token) ?? Task.FromResult<string?>(default)));
        }
        ...
        public async Task<Response<int>> GetUser(string user , Dictionary<string, string?> queryString = default, CancellationToken _token = default , JsonTypeInfo<int> _typeInfo = default)
        {
            ...
            if (_typeInfo != default) 
                return new Response<int>(result.StatusCode,await (result.Content?.ReadFromJsonAsync<int>(cancellationToken: _token , jsonTypeInfo: _typeInfo) ?? Task.FromResult<int>(default)));
            else
                return new Response<int>(result.StatusCode,await (result.Content?.ReadFromJsonAsync<int>(cancellationToken: _token) ?? Task.FromResult<int>(default)));
        }
    ...
    public class WeatherForecastClient
    {
        ...
        public async Task<Response<global::System.Threading.Tasks.Task>> TaskIssue(Dictionary<string, string?> queryString = default, CancellationToken _token = default )
        {
            queryString ??= new();
            using var result = await _client.GetAsync(Microsoft.AspNetCore.WebUtilities.QueryHelpers.AddQueryString($"/WeatherForecast/", queryString), cancellationToken: _token);
            return new Response(result.StatusCode);
